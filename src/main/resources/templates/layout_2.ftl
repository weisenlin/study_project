...
<head>
    ...
    <link rel="icon" type="image/png" href="/admin/assets/i/logo.png">
...
<script src="/admin/assets/js/polyfill/rem.min.js"></script>
<script src="/admin/assets/js/polyfill/respond.min.js"></script>
<script src="/admin/assets/js/amazeui.legacy.js"></script>
<![endif]-->
